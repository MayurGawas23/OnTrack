    ...
    <main className="pt-8 pb-24 px-4 lg:px-8 max-w-7xl mx-auto relative overflow-hidden bg-secondary min-h-screen text-black">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-12">
        ...
        <div className="bg-white p-6 border-2 border-primary paper-stack">
            ...
            <h3 className="font-epilogue font-bold text-xl text-primary overflow-hidden whitespace-nowrap text-ellipsis mt-2">
              {topHabitName}
            </h3>
        </div>
        ...
        <div className="bg-secondary p-8 border border-tertiary/20 rounded-none shadow-[4px_4px_0px_rgba(112,112,112,0.1)] relative paper-texture min-h-[400px]">
           ...
           <div className="h-64 overflow-y-auto pr-4">
              {fitnessLogs.length > 0 ? (
                  <ul className="ruled-line space-y-4">
                      {fitnessLogs.map(log => {
                          ...
                          <li key={log._id} className="pb-4 border-b border-primary/10">
                              <div className="flex justify-between font-bold text-primary font-epilogue mb-1">
                              ...
                              <p className="text-tertiary font-newsreader text-sm line-clamp-2">{log.summary}</p>
                          </li>
                      )})}
                  </ul>
              ) : (
                <div className="text-center h-full flex flex-col justify-center items-center">
                    ...
                    <p className="font-newsreader italic text-tertiary">Accumulate more fitness data to see trends.</p>
                </div>
              )}
           </div>
        </div>
